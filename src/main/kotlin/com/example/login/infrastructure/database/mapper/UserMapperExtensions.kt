...
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User.email
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User.id
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User.name
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User.password
import com.example.login.infrastructure.database.mapper.UserDynamicSqlSupport.User.roleType
