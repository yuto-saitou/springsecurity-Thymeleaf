...
import com.example.login.infrastructure.database.mapper.BookDynamicSqlSupport.Book
import com.example.login.infrastructure.database.mapper.BookDynamicSqlSupport.Book.author
import com.example.login.infrastructure.database.mapper.BookDynamicSqlSupport.Book.id
import com.example.login.infrastructure.database.mapper.BookDynamicSqlSupport.Book.releaseDate
import com.example.login.infrastructure.database.mapper.BookDynamicSqlSupport.Book.title
import com.example.login.infrastructure.database.record.BookRecord
